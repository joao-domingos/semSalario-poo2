...
public class RegistroCtrl {
    ...
    public void atualizar(Registro registro, int id) {
        String sql = "UPDATE registro SET name = ?, type = ?, value = ?, description = ? WHERE id = ?";
        ...
        try {
            ...
            ps.setString(1, registro.getName());
            ps.setString(2, registro.getType());
            ps.setFloat(3, registro.getValue());
            ps.setString(4, registro.getDescription());
            ps.setInt(5, id);
